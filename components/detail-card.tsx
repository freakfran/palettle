    ...
    artwork && (
      <div className="flex mt-5 justify-center mx-auto align-center">
        ...
        <div className="mt-4 ms-12 ml-2">
          ...
          <div className="mt-3 flex justify-start">
            <div className="flex ms-96">
              <div className="Like">
                ...
                {undefined && artwork.attribution.tags.split(",").map((taggg) => (
                  <ClickableButton
                  text={taggg}
          ...
          <DetailTab authorImg={authorImg} name={artwork.name} author={artwork.attribution.author} details={artwork.description}/>
